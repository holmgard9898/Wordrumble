...
export const adventureLevels: AdventureLevel[] = [
  ...
  },
  {
    ...
    intro: {
      en: 'Bombs in the brush! Score 130 in 70 moves before they ignite.',
      sv: 'Bomber i snåret! Nå 130 poäng på 70 drag innan de smäller.',
      de: 'Bomben im Gestrüpp! Erreiche 130 Punkte in 70 Zügen, bevor sie zünden.',
      es: '¡Bombas entre la maleza! 130 puntos en 70 movimientos antes que estallen.',
      fr: 'Des bombes dans les broussailles ! 130 points en 70 coups avant l\'explosion.',
      it: 'Bombe nei cespugli! 130 punti in 70 mosse prima che esplodano.',
      pt: 'Bombas no mato! 130 pontos em 70 jogadas antes de explodirem.',
      nl: 'Bommen in het struikgewas! 130 punten in 70 zetten voor ze ontploffen.',
      no: 'Bomber i krattet! 130 poeng på 70 trekk før de eksploderer.',
  ...
  },
  {
    ...
    intro: {
      en: 'A lone castle in the clearing. Form ONE word worth 30+ points to enter!',
      sv: 'Ett ensamt slott på gläntan. Bilda ETT ord värt 30+ poäng för att komma in!',
      de: 'Eine einsame Burg auf der Lichtung. Bilde EIN Wort mit 30+ Punkten!',
      es: '¡Un castillo solitario! Forma UNA palabra de 30+ puntos para entrar.',
      fr: 'Un château solitaire ! Formez UN mot à 30+ points pour entrer.',
      it: 'Un castello solitario! Forma UNA parola da 30+ punti per entrare.',
      pt: 'Um castelo solitário! Forma UMA palavra de 30+ pontos para entrar.',
      nl: 'Een eenzaam kasteel! Vorm ÉÉN woord van 30+ punten om binnen te komen.',
      no: 'Et ensomt slott! Bilda ETT ord verdt 30+ poeng for å komme inn.',
      da: 'Et ensomt slot! Dann ÉT ord værd 30+ point for at komme ind.',
      fi: 'Yksinäinen linna! Muodosta YKSI sana 30+ pisteellä päästäksesi sisään.',
    },
  ...
  },
  {
    ...
    intro: {
      en: 'Word Surge in the city! Reach 150 points in 50 moves. Long words give bonus moves!',
      sv: 'Word Surge i staden! Nå 150 poäng på 50 drag. Långa ord ger bonusdrag!',
      de: 'Wortwelle in der Stadt! 150 Punkte in 50 Zügen. Lange Wörter geben Bonuszüge!',
      es: '¡Ola de Palabras en la ciudad! 150 puntos en 50 movimientos.',
      fr: 'Vague de Mots en ville ! 150 points en 50 coups.',
      it: 'Onda di Parole in città! 150 punti in 50 mosse.',
      pt: 'Onda de Palavras na cidade! 150 pontos em 50 jogadas.',
      nl: 'Woordgolf in de stad! 150 punten in 50 zetten.',
      no: 'Ordbølge i byen! 150 poeng på 50 trekk.',
      da: 'Ordbølge i byen! 150 point på 50 træk.',
      fi: 'Sana-aalto kaupungissa! 150 pistettä 50 siirrolla.',
    },
    background: 'city',
    mode: 'surge',
    goal: { type: 'reach-score', target: 150 },
    showProgressBar: true,
  ...
  },
  {
    ...
    intro: {
      en: 'Final stop! Score 280 with 5+ letter words. 2 free rockets to clear a column!',
      sv: 'Sista stoppet! Nå 280 poäng med ord på 5+ bokstäver. 2 gratisraketer!',
      de: 'Endstation! Erreiche 280 Punkte mit 5+ Buchstaben. 2 Gratisraketen!',
      es: '¡Última parada! 280 puntos con palabras de 5+ letras. ¡2 cohetes gratis!',
      fr: 'Dernier arrêt ! 280 points avec des mots de 5+ lettres. 2 fusées gratuites !',
      it: 'Ultima fermata! 280 punti con parole di 5+ lettere. 2 razzi gratis!',
      pt: 'Última paragem! 280 pontos com palavras de 5+ letras. 2 foguetes grátis!',
      nl: 'Laatste halte! 280 punten met woorden van 5+ letters. 2 gratis raketten!',
      no: 'Siste stopp! 280 poeng med 5+ bokstaver. 2 gratis raketter!',
      da: 'Sidste stop! 280 point med 5+ bogstaver. 2 gratis raketter!',
      fi: 'Viimeinen pysäkki! 280 pistettä 5+ kirjaimen sanoilla. 2 ilmaista rakettia!',
    },
    background: 'city',
    mode: 'fiveplus',
    goal: { type: 'reach-score', target: 280 },
