      ...
      <div className="w-full max-w-sm">
        <Tabs defaultValue="highscore" className="w-full">
          ...
          <TabsContent value="online" className="mt-4">
            ...
            {!user ? (
              <div className="rounded-2xl p-8 text-center bg-slate-900/70 backdrop-blur-xl border border-white/10 shadow-2xl"><p className="text-white/50">{t.loginForOnline}</p></div>
            ) : loadingOnline ? (
