      ...
      <div className="relative z-10 flex flex-col items-center w-full pb-12">
        ...
        <div className="flex flex-col gap-2 w-full max-w-xs">
          {modes.map((m) => {
            ...
            return (
              <div key={m.path} className="transition-all duration-300 overflow-hidden pb-1 px-2" style={{ maxHeight: isHidden ? 0 : 600, opacity: isHidden ? 0 : 1, marginBottom: isHidden ? -16 : undefined, transform: isHidden ? 'scale(0.95)' : 'scale(1)' }}>
                {!isExpanded ? (
